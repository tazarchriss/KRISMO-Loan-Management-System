 <!-- This page displays a single loan -->
 <?php
  session_start();
  ...
  if ($_SESSION['id']=='') {
    ...
    $sql1="SELECT * FROM user,loan WHERE loan.id='".$_GET['id']."' AND user.id=loan.customer";
        ...
        <div  class="col-md-8 mx-auto " id="home">
            <div class="card mt-3 bg-dark p-2" style="border:1px solid red;color: rgb(2, 96, 112);">
                ...
                <div class="card-body bg-light">
                    <form action="config/cancelloan.php" class="form-group" method="post">
                        ...
                        <div class="col-md-6 float-left ">
                            <label for="amount" class="text-left">Issued Amount</label>
                            <input type="amount" name="amount" class="form-control" id="amount" value="<?php echo $res['issued_amount'] ?>">
                        </div>
                        <div class="col-md-6 float-left">
                          <label for="date" class="text-left">Issued Date</label>
                          <input type="datetime"  class="form-control" value="<?php echo $res['issue_date']; ?>">
                      </div>
                      <div class="col-md-6 float-left">
                        ...
                        <br>
                        <button type="submit" class="btn btn-danger " name="cancel" >Cancel Loan </button>
                        </div>
