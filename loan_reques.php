<!-- This is the page which users apply for loans -->
  <?php
  session_start();
        ...
        <div  class="col-md-8 mx-auto " id="home">
            <div class="card mt-3 bg-dark p-2" style="border:1px solid red;color: rgb(2, 96, 112);">
                ...
                <div class="card-body bg-light">
                    <form action="config/request.php" class="form-group" method="post">
                        <div class="">
                            <label for="date" class="text-left text-bold">Required Date</label>
                            <input type="date" name="rdate" class="form-control" id="date">
                        </div>
                        <div class="">
                            <label for="amount" class="text-left"> Amount</label>
                            <input type="amount" name="amount" class="form-control" id="amount" placeholder="Enter the Amount">
                        </div>
                        <div class="">
                        ...
                        <br>
                        <input type="text" value="<?php echo $_SESSION['id']; ?> "  name="customer" hidden>

                        <button type="submit" name="request" class="btn " style="background-color: rgb(2, 96, 112);color:white;">Request Loan </button>
                    </form>
                </div>
            </div>
