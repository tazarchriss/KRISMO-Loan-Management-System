<!-- This is the page which the admin views all the customers -->
<?php
  session_start();
                        ...
                        <tr>
                          ...
                          <td>
                              <div class="text-center">
                                  <a class="bg-dark p-1 text-light" href="EditEarning.php?id=<?php echo $row['id'];?>"><i class="fa fa-pen "></i></a>
                                  <a class="text-danger p-1" href="config/DeleteEarning.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash "></i></a>
                              </div>
                          </td>
                        </tr>
                        <?php 
