  ...
  <style>
    body{
      background-image: url('body.jpg');
        ...
        <!-- End of navbar -->
  <body class="bg-light" style="background-image: url('body.jpg');">


        <!-- start of navbar-->
        <nav class="navbar navbar-expand-lg navbar-dark m-0 " style="background-color: rgb(2, 96, 112);">
          <a class="navbar-brand" href="#" style="font-weight: bolder;"><b><i>Krismo</i><i class="text-danger">.com</i></b></a>
      ...
      <section class="mt-3">
        <h4 class="text-center  text-bold bg-dark p-2 col-md-8 mx-auto text-danger" style="font-weight: bolder;text-shadow:  seashell;">Welcome to KRISMO Loan Management System</h4>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto card mt-4 p-2" style="opacity:80%;">
                <form method="post" action="config/authentication.php">
                    ...
                    or <a href="register.php" style="font-style:oblique;">Create an Account</a>
                  </form>
            </div>
        </div>
      </section>
